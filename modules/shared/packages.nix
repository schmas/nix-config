...

{
  ...
  # For packages that might require special configuration or are not in nixpkgs
  # you may need to add them separately or use overlays. For example:

  # nixpkgs.overlays = [
  #   (self: super: {
  #     ueberzugpp = super.callPackage ./path/to/ueberzugpp.nix {};
  #   })
  # ];
